...
from ytreza_dev.features.final_version_perfected.injection_keys import TODOLIST_READER_KEY, TASK_FVP_REPOSITORY_KEY, \
    TASK_FVP_READER_KEY, EXTERNAL_TODOLIST_KEY, TASK_INFORMATION_READER_KEY
...
class FvpController:
    ...
    def start_fvp_session(self) -> None:
        ...
        task_repository = self._inject(TASK_FVP_REPOSITORY_KEY)
